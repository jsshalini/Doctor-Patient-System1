    ...
    public void actionPerformed(ActionEvent ae){
        try{        
            if(ae.getSource()==b1){
                ...
                String q  = "select * from login3 where phone = '"+phone+"' and Passward = '"+Passward+"'";
                ...
                // new   newbooking();
                    ...
                    JOptionPane.showMessageDialog(null, "Incorrect phone Number or Passward");
                }
